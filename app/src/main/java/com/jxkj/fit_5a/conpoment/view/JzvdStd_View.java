 ...
 * On 2016/04/18 16:15
 */
public class JzvdStd_View extends Jzvd {
    ...
    public JzvdStd_View(Context context) {
        super(context);
    }

    public JzvdStd_View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.jz_layout_std_view;
    }
