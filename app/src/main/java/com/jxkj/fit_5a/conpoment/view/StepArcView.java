 ...
 */
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.color_text_theme));//设置画笔颜色
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        Paint vTextPaint = new Paint();
        vTextPaint.setTextSize(dipToPx(10));
        vTextPaint.setTextAlign(Paint.Align.CENTER);
        vTextPaint.setAntiAlias(true);//抗锯齿功能
        vTextPaint.setColor(getResources().getColor(R.color.color_999999));
        String stepString = "即时区间";
     ...
     */
    public void setCurrentCount(long totalStepNum, long currentCounts, TextView tv_bfb) {
