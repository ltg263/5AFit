...
public class UserDetailData {
    ...
    public void setBannedEndTime(String bannedEndTime) {
    ...
    public void setBannedStartTime(String bannedStartTime) {
    ...
    public boolean isHasAutoRenew() {
        return hasAutoRenew;
    }

    public void setHasAutoRenew(boolean hasAutoRenew) {
