 ...
 * date   : 2020/5/2914:03
 */
public class HomeShoppingHAdapter extends BaseQuickAdapter<ProductListBean.ListBean, BaseViewHolder> {
    public HomeShoppingHAdapter(@Nullable List<ProductListBean.ListBean> data) {
        super(R.layout.item_home_commodity_h, data);
    }
