...
public class ExerciseRecordDetailsActivity_xl extends BaseActivity {
    ...
    @BindView(R.id.rv_list_px)
    RecyclerView rv_list_px;
    ...
    protected int getContentView() {
        return R.layout.activity_exercise_record_details_xl;
    }
...
//                startActivity(new Intent(FacilityAddPpActivity.this, FacilityAddPpActivity.class));
        ...
        tv_go_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getImgPath(new TaskFinishActivity.Aba() {
                    @Override
                    public void ok() {
                        MapExerciseFinishActivity.shareData(ExerciseRecordDetailsActivity_xl.this,"5Afit_img_1.jpg");
                    }
                });
            }
        });
        ...
        rv_list_px.setLayoutManager(ms);
        rv_list_px.setHasFixedSize(true);
        rv_list_px.setAdapter(mTaskFinishPjAdapter);
...
//    }
    ...
    @OnClick({R.id.iv_back, R.id.rl,R.id.tv_go_xxyx})
