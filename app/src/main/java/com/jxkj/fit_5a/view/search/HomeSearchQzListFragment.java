 ...
 * date   : 2020/6/116:57
 */
public class HomeSearchQzListFragment extends BaseFragment {
...
//内容类型(1:文本;2:图文;3:视频
    private void getData() {
        RetrofitUtil.getInstance().apiService()
                .getHomeSearch(search, "circle",page, ConstValues.PAGE_SIZE)
                ...
                .subscribe(new Observer<Result<HomeSearchBean>>() {
                    ...
                    public void onNext(Result<HomeSearchBean> result) {
                        if (isDataInfoSucceed(result) && result.getData()!=null) {
                            List<CircleQueryJoinedBean.ListBean> data = result.getData().getCircles();
                            if(page==1){
    ...
    private void initList() {
        ...
        mRvDtList.setAdapter(mInterestListAdapter);
