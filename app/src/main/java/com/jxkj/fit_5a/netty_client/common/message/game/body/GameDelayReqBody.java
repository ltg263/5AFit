...
@Data
public class GameDelayReqBody {
    private Long timestamp;

    public GameDelayReqBody() {

    }

    public GameDelayReqBody(Long timestamp) {
    ...
    public GameDelayReqBody(byte[] bytes) throws UnsupportedEncodingException {
        int index = 0;
